      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-16 mb-24">
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-dark-text text-2xl font-extrabold tracking-tight">FitSHOP Snack & Grosir</h2>
            </div>
            <p className="text-dark-text/60 mb-10 max-w-sm leading-relaxed">
              Distributor terpercaya untuk bahan baku makanan dan snack di Jabodetabek. Melayani kebutuhan grosir UMKM dan toko kelontong dengan harga terbaik.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-sm font-medium text-dark-text/60">
              {['Bahan Baku', 'Minyak Goreng', 'Snack Rumahan', 'Biskuit Kaleng'].map((i) => (
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-sm font-medium text-dark-text/60">
              <li className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">call</span> +62 818 1280 88448</li>
              <li className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">mail</span> info@FitSHOPgrosir.com</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-primary/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-[10px] text-dark-text/40 font-bold uppercase tracking-[0.2em]">
            © 2024 FitSHOP Snack & Grosir. Seluruh Hak Cipta Dilindungi.
          </p>
