...
const CTABanner: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-10 py-12">
      <div className="bg-dark-text rounded-[3.5rem] p-12 lg:p-24 text-center relative overflow-hidden shadow-2xl">
        {/* Decor Orbs */}
        ...
        <div className="relative z-10 flex flex-col items-center gap-10">
          <h2 className="text-4xl lg:text-6xl font-black text-white max-w-[900px] leading-tight">
